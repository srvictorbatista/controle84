...
(function (global, factory) {
  ...
  var IFrame = /*#__PURE__*/function () {
    ...
    _proto.createTab = function createTab(title, link, uniqueName, autoOpen) {
      ...
      var newTabItem = "<div class=\"tab-pane fade\" id=\"" + tabId + "\" role=\"tabpanel\" aria-labelledby=\"" + navId + "\"><iframe src=\"" + link + "\" name=\"tab\"></iframe></div>";
    ...
    _proto.switchTab = function switchTab(item, reload) {
      ...
      if (reload) {
        ...
        if (this._config.loadingScreen) {
          $loadingScreen.show(0, function () {
            $__default["default"](tabId + " iframe").attr('name','tab').attr('src', $__default["default"](tabId + " iframe").attr('src')).ready(function (){ 
            // AO RETOMAR UMA PAGINA
          ...
          $__default["default"](tabId + " iframe").attr('name','tab').attr('src', $__default["default"](tabId + " iframe").attr('src'));
        }
      }
      ...
      if (this._config.autoItemActive) { 
        this._setItemActive($__default["default"](tabId + " iframe").attr('src'));
              ...
              ///////////////////////////////////////////////////////////
              //*
              //-- --------| RETIRA CACHE DO IFRAME (ao retornar a mesma URL)
              $('ul[role="tablist"] li[class="nav-item"] a.btn-iframe-close').click();
              window.open('JavaScript:window.location.reload();window.location.reload(true);location.reload();','tab');
              setTimeout(function(){
                  //$('ul[role="tablist"] li[class="nav-item active"] a.active').click();
                if(window.screen.width <= 779){
